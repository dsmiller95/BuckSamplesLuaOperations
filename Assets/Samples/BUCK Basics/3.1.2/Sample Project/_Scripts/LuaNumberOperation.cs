...
using Lua;
using UnityEngine;
using static Buck.NumberOperation;
...
namespace Buck.Samples
{
    ...
    public class LuaNumberOperation : BaseOperation
    {
        ...
        /// </summary>
        public LuaNumberOperation(string expression, NumberVariable numberA, NumberReference numberB, NumberReference numberC, RoundingType rounding, BoolReference raiseEvent)
        {
        ...
        public void SetValues(NumberVariable numberA, NumberReference numberB, NumberReference numberC, string expression, RoundingType rounding)
        {
            m_numberA = numberA;
            m_numberB = numberB;
            m_numberC = numberC;
